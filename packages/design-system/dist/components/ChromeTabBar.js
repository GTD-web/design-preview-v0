...
const Tabs = dynamic(() => import("@sinm/react-chrome-tabs").then((mod) => ({ default: mod.Tabs })), {
    ssr: false,
 ...
 */
export function ChromeTabBar({ tabs = [], onTabClick, onTabClose, onTabReorder, onNewTab, maxTabs = 10, className = "", showNewTabButton = true, darkMode = false, }) {
    // 스타일 주입 (클라이언트에서만)
    useEffect(() => {
        injectCustomStyles();
    }, []);
    ...
    const containerClass = [
        ...
        .filter(Boolean)
        .join(" ");
    return (React.createElement("div", { className: containerClass, style: {
        ...
        React.createElement("div", { style: { flex: 1, height: "46px" } },
            React.createElement(Tabs, { tabs: chromeTabsData, onTabActive: handleTabClick, onTabClose: handleTabClose, onTabReorder: handleTabReorder, darkMode: darkMode, className: "chrome-tabs-custom" })),
        showNewTabButton && (React.createElement("button", { onClick: handleNewTabClick, disabled: tabs.length >= maxTabs, className: "new-tab-button", style: {
                width: "28px",
                height: "28px",
            ...
            React.createElement("svg", { width: "12", height: "12", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "1.5", strokeLinecap: "round", strokeLinejoin: "round" },
