 ...
 */
export const createTabFinder = (getPathForTabComparison) => {
    return (tabs, pageInfo, normalizedPath) => {
 ...
 */
export const findMatchingTab = (tabs, currentFullPath, getPathForTabComparison) => {
 ...
 */
export const countSamePathTabs = (tabs, pathForComparison, getPathForTabComparison) => {
 ...
 */
export const checkTabExists = (tabs, normalizedPathname, getPathForTabComparison) => {
    // 먼저 완전히 동일한 경로로 탭 찾기
    ...
    if (!existingTab) {
        const currentPathForComparison = getPathForTabComparison(normalizedPathname);
